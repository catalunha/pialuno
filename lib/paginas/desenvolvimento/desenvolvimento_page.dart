...
class _DesenvolvimentoState extends State<Desenvolvimento> {
  ...
  Future cadastrarTarefa(String tarefaId) async {
    ...
    TarefaModel tarefaModel = TarefaModel(
      ...
      inicio: DateTime.parse('2019-11-29T08:00:00.000Z'),
      // iniciou: DateTime.parse('2019-11-29T09:00:00.000Z'),
      // editou: DateTime.parse('2019-11-29T09:30:00.000Z'),
      fim: DateTime.parse('2019-11-29T12:00:00.000Z'),
      tentativa: 3,
      // tentou: 0,
      tempo: 2,
      podeResolver: true,
